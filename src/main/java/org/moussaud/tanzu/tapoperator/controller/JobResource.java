...
public abstract class JobResource extends BaseResource<Job> {
    ...
    public Job Xcreate(Job desired, TapResource primary, Context<TapResource> context) {
    ...
    public Job Xupdate(Job actual, Job desired, TapResource primary, Context<TapResource> context) {
